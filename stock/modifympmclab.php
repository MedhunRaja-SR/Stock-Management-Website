...
<body text="green">
<br/>
<h2 style="color:black;text-align:center">MP & MC Database</h2>
<center>
<br/><br/>
<table border="1" width="25%"  bgcolor="BLACK" cellpadding="3px">
	...
	<tr>
		...
		<td>
			<form>
               <a href="updatempmclab.php?number=<?php echo $number; ?>" class="s1" onclick="return confirm ('Are you want to delete...?');">UPDATE</a>
			</form>
		</td>
		<td>
			<form>
               <a href="deletempmclab.php?number=<?php echo $number; ?>" class="s1" onclick="return confirm ('Are you want to delete...?');">DELETE</a>
			</form>
		</td>
	</tr>
	<?php
