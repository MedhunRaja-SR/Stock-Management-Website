...
if(isset($_POST['submit'])){
	...
	if($insert_row){
		...
		die("Query for others products is not executed");
		}
	
}

	$query = "SELECT * FROM others";
	$others = mysqli_query($conn,$query);
	$total = mysqli_num_rows($others);
	$next = $total+1;
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Other Products</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
