...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO air_conditioner(";
	...
	if($insert_row){
		...
		die("Query for Air Conditioner is not executed");
		}
	
}

	$query = "SELECT * FROM air_conditioner";
	$aircon = mysqli_query($conn,$query);
	$total = mysqli_num_rows($aircon);
	$next = $total+1;
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Air Conditioner</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
					...
					<form method="POST" action="aircon.php">
						<p>
