...
if(isset($_POST['submit'])){
	...
	if($insert_row){
		...
		die("Query for software lab is not executed");
		}
	
}

	$query = "SELECT * FROM soft_lab";
	$soft = mysqli_query($conn,$query);
	$total = mysqli_num_rows($soft);
	$next = $total+1;
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Software Laboratory</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
					...
					<form method="POST" action="softlab.php">
						<p>
