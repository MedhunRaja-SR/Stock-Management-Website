...
if(isset($_POST['submit'])){
	...
	if($insert_row){
		...
		die("Query for projector is not executed");
		}
	
}

	$query = "SELECT * FROM projector";
	$projector = mysqli_query($conn,$query);
	$total = mysqli_num_rows($projector);
	$next = $total+1;
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Projector</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
					...
					<form method="POST" action="projector.php">
						<p>
