...
if(isset($_POST['submit'])){
	...
	if($insert_row){
		...
		die("Query for Mp & Mc lab is not executed");
		}
	
}

	$query = "SELECT * FROM mpmc_lab";
	$mpmc = mysqli_query($conn,$query);
	$total = mysqli_num_rows($mpmc);
	$next = $total+1;
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Microprocessor and Microcontroller Laboratory</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
					...
					<form method="POST" action="mpmclab.php">
						<p>
