...
if(isset($_POST['submit'])){
	...
	$query = "UPDATE furniture SET item_text='{$item_text}',stock_book='{$stock_book}',book_stock='{$book_stock}',
...
<html>
	...
	<center>
		<header>
			<div class="container">
				<h2 style="color:#1BD935"><b>Furniture Database</b></h2>
			</div>
		</header>
		<main>
				<div class="container">
					...
					<form method="POST" action="updatefurniture.php" onsubmit="return confirm ('Are you confirm changes...?');">
						<p>
